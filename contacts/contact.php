...
$contact_old     = $_SESSION['contact_old'] ?? array(
    'name' => '',
    'email' => '',
    'message' => ''
);
...
<section class="final-cta" id="contact">
    <div class="container final-cta-content">
        ...
        <p class="body-text" style="text-align:center;">
            Questions about an order, sizing, or anything else — send us a message and we'll get back to you.
        </p>
            ...
            <form class="contact-form" method="post">
                ...
                <div class="form-row">
                    ...
                    <textarea
                        ...
                        rows="4"
                        required
                    ><?php echo safe_output($contact_old['message']); ?></textarea>
                </div>
