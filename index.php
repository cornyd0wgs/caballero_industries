...
// Get all products for the collection.
$stmt = $conn->prepare(
    'SELECT *
     FROM products
  ...
  <div class="container ethos-grid">
    ...
    <div class="ethos-image">
      <img
        ...
        alt="Caballero Industries black tactical hoodie"
      ...
      <?php foreach ($principles as $principle) : ?>
        <article class="principle-card">
          ...
          <h3 class="principle-title">
            <?php echo $principle['title']; ?>
          </h3>

          <p class="principle-text">
            <?php echo $principle['text']; ?>
          </p>
        </article>
      <?php endforeach; ?>
    </div>
...
<section class="collection" id="gallery">
  <div class="container">
    ...
    <?php if (empty($collection_products)) : ?>
      ...
      <p class="body-text">
        No products yet — add one from the admin panel.
      </p>
          ...
          >
            ...
            <div class="product-image">
              ...
              <?php if ((int) $product['quantity'] === 0) : ?>
                <span class="product-tag product-tag-soldout">
                  SOLD OUT
                </span>
              <?php endif; ?>
...
<section class="feature-cta">
  ...
  <div class="container feature-cta-content">
    ...
    <p class="section-index section-index-light">
      VANGUARD_BROADCAST // 04
    </p>
